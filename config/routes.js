...
module.exports.routes = {
  ...
  "PUT /api/v1/admin/doctor/refresh-token": { action: "auth/refresh-token" },
  ...
  "GET /api/v1/admin/patient/my-old-bookings/:id": {
    action: "patient/my-bookings/fetch-old-bookings",
  },
